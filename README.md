...
- Разработал первую версию проекта [<b>ArcheAgeTools</b>](https://github.com/symphograph/ArcheAgeTools) для игроков MMO ArcheAge 

  (PHP, MySQL, jQuery) 

    Проект предоставляет рад вычислительных сервисов для игрового процесса и взаимодействия пользователей
